...
<form name="searchForm" action="${pageContext.request.contextPath }/yk" method="post" >
...
<table>
	...
	<td>
		...
		<td width="100">		
		<form name="goForm" action="${pageContext.request.contextPath }/yk" method="post">
	...
	<p>                                      
	<form action="${pageContext.request.contextPath }/input/search.jsp?id=1" method="post">
